...
from pipeline.common.downloads import read_lines, _read_lines_single_file, write_lines
...
def filter_and_write_monolingual_data(
    ...
    logger.info("Deduplicated and shuffling lines.")
    ...
    logger.info("Write out the final file")
    with write_lines(output_path) as outfile:
        ...
        for i, line in enumerate(final_lines):
            ...
            if i % 1_000_000 == 999_999:
                print(f"Wrote line {i+1:,} to {output_path}")

    logger.info("Write out a 10,000 line sample of the final")
    ...
    stats.save_json(output_path.parent / f"{output_path.stem}.stats.json")

...
def main() -> None:
    ...
    parser.add_argument("--tok_src_url", type=str, default="", help="The (optional) source URL for the tokenized corpus")
    parser.add_argument("--tok_trg_url", type=str, default="", help="The (optional) target URL for the tokenized corpus")
    parser.add_argument("--alignments_url", type=str, default="", help="The (optional) alignments file URL for this file")
    ...
    if tok_src_url or tok_trg_url or alignments_url:
        assert tok_src_url and tok_trg_url and alignments_url, "All three URLs must be provided for the tokenized corpus."

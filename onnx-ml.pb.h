...
inline ::onnx::TensorProto_DataType TypeProto_SparseTensor::elem_type() const {
  // @@protoc_insertion_point(field_get:onnx.TypeProto.SparseTensor.elem_type)
  return static_cast< ::onnx::TensorProto_DataType >(elem_type_);
}
inline void TypeProto_SparseTensor::set_elem_type(::onnx::TensorProto_DataType value) {
  assert(::onnx::TensorProto_DataType_IsValid(value));
  set_has_elem_type();
  elem_type_ = value;

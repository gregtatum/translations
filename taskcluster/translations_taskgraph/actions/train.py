...
@register_callback_action(
    ...
    context=[],
    available=can_train,
    schema=lambda _graph_config: build_json_schema(TrainingConfig),
)
def train_action(
    ...
    # This is the CI config by default. Set it to the current input training_config.
    parameters.training_config = training_config

    # TODO(greg) - Validate valid start-stage and target-stage here.
    # graph_config["start-stage"]
    # graph_config["target-stage"]

...
extend_parameters_schema(
    {
        Required("training_config"): {
            ...
            Required("experiment"): {
                ...
                Required("mono-max-sentences-trg"): {Required("total"): int, Required("per-dataset"): int},
                Required("mono-max-sentences-src"): {Required("total"): int, Required("per-dataset"): int},

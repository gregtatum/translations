...
def test_teacher_original_alignments():
    ...
    data_dir.run_task("alignments-parallel-en-ru", env=env)
...
def test_teacher_backtranslated_alignments():
    ...
    data_dir.run_task("alignments-backtranslations-en-ru", env=env)
...
def test_student_alignments():
    ...
    data_dir.run_task("alignments-distillation-en-ru", env=env)

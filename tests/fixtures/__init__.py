    ...
    return json.dumps(
        {
            ...
            "https://data.hplt-project.org/one/monotext/cleaned/zh_map.txt":
                get_path("hplt-zh_map.txt"),
            "https://data.hplt-project.org/one/monotext/cleaned/zh/zh.jsonl.zst":
                get_path("hplt-zh.jsonl.zst"),
        }
    )  # fmt: skip

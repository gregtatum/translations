...
USAGE = """fxtranslate — translate with Firefox Translations models
...
MODELS_USAGE = """fxtranslate models — manage locally cached models
...
LIST_USAGE = """fxtranslate list — list supported languages and models
